...
class CfgRemoteExec {
    class Functions {
        ...
        F(life_fnc_copPhaser,CLIENT)
        F(life_fnc_copRumbler,CLIENT)
        F(life_fnc_copWail,CLIENT)
        ...
        F(life_fnc_licenceCheck,CLIENT)
        F(life_fnc_licencesRead,CLIENT)
        ...
        F(life_fnc_removeLicences,CLIENT)
        ...
        F(life_fnc_farmingPlantServer,SERVER)
        ...
        F(bis_fnc_settasklocal_handlejip,ANYONE)
    };
