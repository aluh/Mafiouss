...
if (((nearestObject [[5803.43,10428,0.915003],"Land_Offices_01_V1_F"]) == _building) && (west countSide playableUnits < (LIFE_SETTINGS(getNumber,"minimum_cops")))) exitWith {
...
if ((nearestObject [[5803.43,10428,0.915003],"Land_Offices_01_V1_F"]) == _building) then {
