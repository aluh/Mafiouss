...
switch (playerSide) do {
    ...
    case civilian: {
        ...
        life_xpcheck = LIFE_SETTINGS(getNumber,"paycheck_civ_xp");
    };
    case independent: {
...
diag_log "::Life Client:: Setting Cell Phone check";
[] call life_fnc_cellPhoneCheck;

diag_log "::Life Client:: Cell Phone check completed";
