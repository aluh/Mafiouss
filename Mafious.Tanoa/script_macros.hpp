...
#define PLAYER_EXP life_exp
#define PLAYER_LEVEL life_level
#define LEVEL_COEF 0.15
#define GANG_FUNDS group player getVariable ["gang_bank",0];
#define CURRENCY "$"

//Useful Maths Macros...
#define GET_REM(var1,var2) ((var1/var2)-(floor(var1/var2)))*var2
#define GET_MULT(var1,v2) floor(var1/var2)
...
//System Macros
#define LICENCE_VARNAME(varName,flag) format["licence_%1_%2",flag,M_CONFIG(getText,"Licences",varName,"variable")]
#define LICENCE_VALUE(varName,flag) missionNamespace getVariable [LICENCE_VARNAME(varName,flag),false]
