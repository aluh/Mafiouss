...
"A3_Data_F_Curator_Misc","A3_Data_F_Curator_Respawn","A3_Data_F_Kart","A3_Data_F_Kart_ParticleEffects","A3_Language_F_Curator","A3_Language_F_Kart","A3_LanguageMissions_F_Kart","A3_Map_Tanoa","A3_Map_Tanoa_Data",
"A3_Map_Tanoa_Data_Layers","A3_Map_Tanoa_Scenes_F","A3_Missions_F","A3_Missions_F_Data","A3_Missions_F_Video","A3_Missions_F_Beta","A3_Missions_F_Beta_Data","A3_Missions_F_Beta_Video","A3_Missions_F_Gamma",
...
"A3_UAV_F_Weapons_F_Gamma_Ammoboxes","A3_Weapons_F_gamma_Items","A3_Map_Tanoa_Scenes","A3_Map_Stratis_Scenes","Map_VR","A3_Map_VR_Scenes","A3_Modules_F_Heli_SpawnAi","A3_Modules_F_Mark_Objectives","A3_Signs_F_AD",
...
for "_i" from 0 to count (_binConfigPatches)-1 do {
    private _patchEntry = _binConfigPatches select _i;
    if (isClass _patchEntry) then {
...
*/
{
    private _onLoad = getText(configFile >> (_x select 0) >> "onLoad");
    private _onUnload = getText(configFile >> (_x select 0) >> "onUnload");
