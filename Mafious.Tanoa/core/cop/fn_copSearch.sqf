...
if((_civ getVariable["playerSurrender",false]) && (20 > random 100)) exitWith { hint parseText format["<t color='#FF0000'><t size='2'>%1</t></t><br/><t color='#FFD700'><t size='1.5'><br/>" +(localize "STR_Cop_IllegalItems")+ "</t></t><br/>%2<br/><br/><br/><br/><t color='#FF0000'>%3</t>"
,(_civ getVariable ["realname",name _civ]),localize "STR_Cop_NoIllegal",if (_robber) then {"Robbed the bank"} else {""}];};
