...
switch (typeOf _vehicle) do
{
    ...
    {
        _lightleft lightAttachObject [_vehicle, [-0.37, 0.0, 0.1]];
    };
    case "C_Offroad_02_unarmed_F":
    {
        _lightleft lightAttachObject [_vehicle, [-0.43, 0.0, 0.46]];
    };
    case "B_MRAP_01_F":
    {
...
switch (typeOf _vehicle) do
{
    ...
    case "B_T_LSV_01_unarmed_black_F":
    {
        _lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.1]];
    };
    case "C_Offroad_02_unarmed_F":
    {
        _lightright lightAttachObject [_vehicle, [0.43, 0.0, 0.46]];
    };
    case "B_MRAP_01_F":
    {
