...
*/
private["_exit","_shopSide","_licence","_levelAssert","_levelName","_levelType","_levelValue","_levelMsg","_flag"];
if (isNil {(_this select 3)}) exitWith {};
_exit = false;
_shopSide = M_CONFIG(getText,"VirtualShops",(_this select 3),"side");
_licence = M_CONFIG(getText,"VirtualShops",(_this select 3),"licence");
