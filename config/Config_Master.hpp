...
/* Logging and Security Settings*/
    ...
    player_moneyLog = false; //False [default] - No money logging. True - Logs player bank deposits, withdraws, and transfers, gang bank deposits and withdraws, money picked up off of the ground, and player robbery. Search for: fluxcapacitor_log
...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","sugarcane","papaya","cocoa","banana","orange","sugarcaneseeds","papayaseeds","cocoaseeds","bananaseeds","orangeseeds","hoe","axe","timber","lumber" }; //Array of virtual items that can be saved on your player.
    ...
    save_vehicle_items[] = { "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit","sugarcane","papaya","cocoa","banana","orange","sugarcaneseeds","papayaseeds","cocoaseeds","bananaseeds","orangeseeds","hoe","axe","timber","lumber"  };
...
/* System Settings */
    ...
    minimum_cops = 8; //Minimum cops required online to rob the Federal Reserve - SET TO 1 for DEBUG ONLY
    ...
    service_chopper = 100;  //Cost to service chopper at chopper service station(Repair/Refuel).
    ...
    animaltypes_hunting[] = { "Hen_random_F", "Cock_random_F", "Rabbit_F", "Goat_random_F","Sheep_random_F"  }; //Classnames of aniamls you can hunt/gut
    animaltypes_milking[] = { "Goat_random_F"};  //Classnames of animals you can milk for milk!
    animaltypes_shearing[] = { "Sheep_random_F"}; //Classnames of animals you can shear for their wool

    /* Farming Related Settings */
    enable_wild_farming = true;

    /* Lumber Related Settings */
    enable_lumbering = true;


    /* Truck Mission Settings */
    truck_legal_levelrequired = 10; //Level required to take a truck mission
    truck_illegal_levelrequired = 10;   // Level required to take a truck mission.

    _truck_mission_legal_rpxp_modifier = 0.1;   //Multiply distance by this number to reward RPXP on succesful delivery
    _truck_mission_illegal_rpxp_modifier = 0.05;   //Multiply distance by this number to reward RPXP on succesful delivery

    truck_legal_modifier = 0.8; //Modifier to calculate reward of Legal Truck Missions (Distance multiplied by this number)
    truck_illegal_modifier = 1.2; //Modifier to calculate reward of Legal Truck Missions (Distance multiplied by this number)
    truck_searched_modifier = 4; // Divide total reward by this number if the vehicle is searched and its goods confiscated before reaching destination.
    truck_searched_cop_percentage = 0.1; //10% value is distributed to the police
    // Percentage of total cargo value to reward to players on successful delivery. 1 = 100%     0.01 = 1%
    truck_legal_cargovalue_reward = 0.015; // 1.5%    //Percentage of the value of the cargo to be rewarded
    truck_illegal_cargovalue_reward = 0.025; // 2.5%  //Percentage of the value of the cargo to be rewarded
    truck_max_reward = 65000; //Maximum you can get from truck missions
    ...
    sendtoJail_locations[] = { "cop_spawn_bluepearl","cop_spawn_georgetown","cop_spawn_larochelle","cop_spawn_bluepearl","cop_spawn_lijnhaven" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    ...
    bank_civ = 11000; //Amount of cash in bank for new civillians
    ...
    paycheck_civ_xp = 1;  //XP Payment per five minutes
